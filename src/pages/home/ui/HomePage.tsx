...
const RoleCard: React.FC<{
  ...
  return (
    <div className="bg-zinc-900/40 backdrop-blur-xl border border-white/10 rounded-3xl p-8 flex flex-col items-center text-center transform hover:-translate-y-2 transition-transform duration-300 z-10 relative group">
      ...
      <button
        onClick={onSelect}
        className="w-full px-5 py-3 bg-emerald-600 text-white font-semibold rounded-full hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-emerald-500 transition-colors shadow-lg shadow-emerald-600/20"
      >
        Enter Portal
      </button>
    </div>
